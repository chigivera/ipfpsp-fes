...
export default function ProgramsSection() {
  ...
  return (
    <section id="programs" className="py-20 bg-card/30 scroll-mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Diplomas Section */}
        <div id="diplomas" className="mb-16 scroll-mt-24">
        ...
        {/* Formations Section */}
        <div id="formations" className="mb-16 scroll-mt-24">
        ...
        {/* Online Learning */}
        <div id="online" className="mb-16 scroll-mt-24">
        ...
        {/* Companies Section */}
        <div id="companies" className="mb-16 scroll-mt-24">
